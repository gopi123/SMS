...
$(function () {
    ...
    //show alert for invalid image file
        ...
        $("#frmAdd").ajaxSubmit({
            ...
            success: function (result) {
                ...
                if (result.message == "success") {
                    ...
                    toastr.error("Exception:" + result.message);
                }
            },
            error: function (xhr, textStatus, errorThrown) {
                isLoading(false);
                toastr.error("Error:Something gone wrong"+errorThrown)
