...
$(function () {
    ...
    form.find("#WalkInnStepz").steps({
        ...
        onStepChanging: function (event, currentIndex, newIndex) {           
            ...
            if (form.valid()) {
                if (currentIndex == 0) {
                    return ValidateParentChildPhoneNo();
                }
    ...
    var clearAll = function () {
        ...
        $("#ddlCareGiver").select2("val", "");
        $("#ddlQlfnMain").select2("val", "");
        $("#ddlQlfnType").select2("val", "");
        $("#ddlQlfnSub").select2("val", "");
        $("#ddlCustomerType").select2("val", "");
        $("#ddlKnowHow").select2("val", "");
        $("#ddlPlacement").select2("val", "");
        $("#ddlWhyNS").select2("val", "");
        $("#ddlCRO2").select2("val", "");      
        $("#ddlEquipmentDemo").select2("val", "");
        $("#ddlCourseList").select2("val", "");
        $("#ddlBatchPreferred").select2("val", "");
        $("#ddlCenter").select2("val", "");
        $("#ddlCurrentYear").select2("val", "");
        //Checkbox check change
        $('.chkbxSwitch').prop('checked', false);
        $('.chkbxSwitchReverse').prop('checked', true);
        //CustomerTypeDiv visible false
        $(".student").slideUp();
        $("#divCollege").slideUp();
        $(".nonemploy").slideUp();
        $(".employ").slideUp();
        //Show OtherDetails Div
        $(".prevExp").slideDown();
        $(".demogiven").slideDown();
        $(".joinreason").slideDown();
        $(".notjoinreason").slideUp();
    ...
    //This function checks whether the caretaker and student has the same mobile no and will return false if so

    function ValidateParentChildPhoneNo() {
        var isValidate = true;
        ...
        if (studentMobileNo == guradianNobileNo) {
            bootbox.alert("Student MobileNo and CareGiver ContactNo cannot be the same");
            isValidate = false;
        }
