...
$(function () {
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    return '<div >' +
                                ...
                                '</div>' +
                                '<div class="col-sm-4">' +
                                    '<a class="btn btn-danger deleteData pull-left" data-id=' + data + ' data-name="' + row.CourseCode + '" >' +
    ...
    var ajaxEditGet = function () {
        ...
        var multiCourseId = $(this).data('id');
        ...
        $.ajax({
            type: "GET",
            url: href,
            data: { multiCourseId: multiCourseId },
    ...
    var ajaxDelete = function (id) {
        ...
        $.ajax({
            type: "POST",
            url: href,
            data: JSON.stringify({ multiCourseId: id }),
            datatype: "json",
    ...
    $(document).on("click", ".deleteData", function () {
        var multiCourseId = $(this).data("id");
        var multiCourseName = $(this).data("name");

        bootbox.confirm("Are you sure you want to delete <strong>" + multiCourseName + "</strong>?", function (result) {
            if (result) {
                ajaxDelete(multiCourseId)
            }
        });
