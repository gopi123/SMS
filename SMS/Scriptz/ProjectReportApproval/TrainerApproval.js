...
$(function () {
    ...
    var isApproved = function () {
        ...
        var isCrossChecked = $(".crosschecked:checked").val();
        var isProjectNotCopied = $(".projectCopied:checked").val();
        var isUploadedSameCourseProjectReport = $(".uploadedProject:checked").val();
        var isProjectDifferentFromLabExercise = $(".labExerciseProject:checked").val();

        if (isSourceCodeCollected == "False" || isCrossChecked == "False" || isProjectNotCopied == "False" || isUploadedSameCourseProjectReport == "False" || isProjectDifferentFromLabExercise == "False") {
            approved = false;
        }
